...
public class CustomerController {
    ...
    @GetMapping
    public ResponseEntity<List<CreateCustomerResponse>> findAll() {
        return ResponseEntity.ok()
                .body(customerCommandHandler.findAll());
    }

    @GetMapping("/{id}")
    public ResponseEntity<CreateCustomerResponse> findById(@PathVariable UUID id) {
        return ResponseEntity.ok()
                .body(customerCommandHandler.findById(id));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<CreateCustomerResponse> deleteById(@PathVariable UUID id) {
